A Command-Line Interface(CLI) Application that encrypts and decrypts messages with a secret password that can be changed in the Python code by the user for personal use.
